...
<body>
  ...
  <section class="topContent">
    ...
    <div class="topContentImg">
      <img src="images/home.png" alt="Banking">
    </div>
  </section>
  <!-- End Home -->
  <!-- About -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:400px;" src="images/bank.jpg" alt="TSF Bank">
        </div>
    ...
    <div class="container  text-center">
      <div class="row">
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/viewcustomer.jpg" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
            <h5 class="card-title">Add Customers</h5>
            <p class="card-text">Add Customer's data</p>
            <a href="addcustomer.php" class="btn btn-primary">Add Customers</a>
          </div>
        </div>
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/viewtransaction.jpg" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/transfermoney.png" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
  ...
  <footer>
    ...
    <p class="text-copy">
      Copyright &copy; 2021 All rights reserved Created By <a href ="#">Dhruv Suthar</a>
    </p>
  </footer>
  <!-- End Footer -->
